...
namespace BeautyNEM_API.Migrations
{
    ...
    [Migration("20230126104419_Add_column_IsReminded_For_NotificationCustomer_Table")]
    partial class Add_column_IsReminded_For_NotificationCustomer_Table
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BeautyNEM_API.Models.BeautyShop", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("BeautyShop");
                });

            modelBuilder.Entity("BeautyNEM_API.Models.BeautyShopImage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("BeautyShopId");

                    b.HasIndex("ProductId");

                    b.ToTable("BeautyShopImage");
                });
            ...
            modelBuilder.Entity("BeautyNEM_API.Models.NotificationBeautician", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("NotificationBeautician");
                });

            modelBuilder.Entity("BeautyNEM_API.Models.NotificationCustomer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("NotificationCustomer");
                });

            modelBuilder.Entity("BeautyNEM_API.Models.Product", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BeautyNEM_API.Models.BeautyShopImage", b =>
                {
                    b.HasOne("BeautyNEM_API.Models.BeautyShop", "BeautyShop")
                        .WithMany()
                        .HasForeignKey("BeautyShopId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BeautyNEM_API.Models.Product", "Product")
                        .WithMany()
                        .HasForeignKey("ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("BeautyShop");
            ...
            modelBuilder.Entity("BeautyNEM_API.Models.Event", b =>
                {
                    ...
                    b.HasOne("BeautyNEM_API.Models.Rating", "Rating")
                        .WithMany()
            ...
            modelBuilder.Entity("BeautyNEM_API.Models.Product", b =>
                {
                    b.HasOne("BeautyNEM_API.Models.BeautyShop", "Shop")
                        .WithMany()
